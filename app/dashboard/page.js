...
export default function DashboardPage() {
  ...
  async function deleteParcel(id) {
    if (!confirm("Supprimer définitivement cette parcelle ? Cette action est irréversible.")) return;
  ...
  async function deletePayment(id) {
    if (!confirm("Supprimer définitivement ce paiement ? Cette action est irréversible.")) return;
            ...
            return (
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <button
                    className="btn secondary"
                    style={{ padding: "6px 10px", fontSize: 12, borderColor: "rgba(196,89,63,0.5)", color: "#C4593F" }}
