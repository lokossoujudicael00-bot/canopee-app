  ...
  return (
    ...
    >
      ...
      <p style={{ color: "rgba(233,228,216,0.6)", maxWidth: 560, marginBottom: 32 }}>
        Collecte les données GPS de vos producteurs, suit les paiements, et génère
        automatiquement vos déclarations de conformité déforestation.
      </p>
      ...
      <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
        ...
        <Link href="/paiement" className="btn" style={{ textDecoration: "none", display: "inline-block", background: "#C99B4E" }}>
